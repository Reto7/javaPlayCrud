...
public class ProductJDBC {
    ...
    private static List<ProductJDBC> products;
    // statischer Initialisierer,
    static {
        products = new ArrayList<ProductJDBC>();
    }
...
//    }
    ...
    public ProductJDBC(String ean, String name, String description) {
        this.ean = ean;
        this.name = name;
        this.description = description;
    }
    public ProductJDBC(int id, String ean, String name, String description) {
        this.id = id;
        this.ean = ean;
        this.name = name;
        this.description = description;
    ...
    public static List<ProductJDBC> findAll(Database db){
        // get connection
        Connection connection = db.getConnection();
        Statement stmt = null;

        // aktuelle liste aller produkte
        List<ProductJDBC> products = new ArrayList<ProductJDBC>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ProductJDBC product = new ProductJDBC(id,ean,name,description);
     ...
     */
    public static void addProduct(ProductJDBC newProduct, Database db) {
        // in die DB schreiben
        newProduct.save(db);
     ...
     * Diese bekommen wir von der DB zurueck
     */
    public static void modifyProduct(ProductJDBC modifyedProduct, Database db) {
        // in die DB schreiben
...
//    }
    ...
    public static ProductJDBC findProductById(Integer id, Database db) {
        ...
        if (id > 0) {
            try {
                ...
                while (rs.next()){
                    ...
                    String description = rs.getString("description");
                    // generate new Product
                    product = new ProductJDBC(id,ean,name,description);
                }
                rs.close();
            } catch (SQLException e) {
                e.printStackTrace();
